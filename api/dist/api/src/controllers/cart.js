...
exports.payCart = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const cartId = Number(req.params.cartId);
        yield cart_1.default.payCart(cartId);
        res.status(200).send();
    }
    catch (error) {
        if (error instanceof Error && error.name == 'ValidationError') {
...
exports.findAll = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return res.json(yield cart_1.default.getCarts());
    }
    catch (error) {
        if (error instanceof Error && error.name == 'ValidationError') {
            next(new apiError_1.BadRequestError('Invalid Request', error));
...
exports.findByUserEmail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        return res.json(yield cart_1.default.getUserCart(email));
    }
    catch (error) {
        if (error instanceof Error && error.name == 'ValidationError') {
            next(new apiError_1.BadRequestError('Invalid Request', error));
...
exports.findPaidCarts = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = Number(req.params.userId);
        return res.json(yield cart_1.default.getPaidCarts(userId));
    }
    catch (error) {
        if (error instanceof Error && error.name == 'ValidationError') {
            next(new apiError_1.BadRequestError('Invalid Request', error));
